 ...
 *
 * Pass 3 (world): the road used to be a dead-straight treadmill - pixel-for-
 * pixel the same at 100 m and 3600 m. Now the highway goes somewhere: the
 * centreline winds on layered sines, lane markings, verges and traffic follow
 * the bend, roadside posts and trees stream past to sell the curve, and
 * centrifugal drift pushes the car outward in hard bends at speed, so the
 * bends have to be driven, not just watched.
 *
